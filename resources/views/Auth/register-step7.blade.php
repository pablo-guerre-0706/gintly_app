...
<body data-registration-step="7" class="registration-page bg-white flex items-center justify-center h-screen w-screen overflow-hidden">
    ...
    <div class="signup-container">
        ...
        <div class="w-full flex-1 relative flex items-start justify-center overflow-hidden">
            ...
            <div class="absolute w-[1400px] h-[400px] mt-8 top-[35px] pointer-events-none">
                ...
                <div class="absolute top-[0px] left-[200px] w-[1000px] h-[450px] bg-[url('/images/catalogoproductos.png')] bg-white rounded-3xl shadow-xl border border-slate-200/80 overflow-hidden transform rotate-0 transition-all duration-500 ease-out hover:scale-[1.01] hover:z-25 origin-top pointer-events-auto cursor-pointer dashboard-bg">
                </div>

                <!-- 2. Dashboard Izquierda (General / dashboard - Rotación negativa -->
                <div class="absolute top-[75px] left-[-70px] w-[900px] h-[480px] bg-[url('/images/dashboard.png')] bg-white rounded-3xl shadow-2xl border border-slate-200/80 overflow-hidden transform rotate-12 transition-all duration-500 ease-out hover:scale-[1.01] hover:rotate-12 hover:z-30 origin-top-left pointer-events-auto cursor-pointer dashboard-bg">
                </div>

                <!-- 3. Dashboard Derecha (cierre de caja) - Rotación negativa -->
                <div class="absolute top-[75px] right-[-70px] w-[900px] h-[480px] bg-[url('/images/cierrecaja.png')] bg-white rounded-3xl shadow-2xl border border-slate-200/80 overflow-hidden transform -rotate-12 transition-all duration-500 ease-out hover:scale-[1.01] hover:-rotate-12 hover:z-30 origin-top-right pointer-events-auto cursor-pointer dashboard-bg">
                </div>
