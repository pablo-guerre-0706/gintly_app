...
<head>
    ...
    <!-- Estilos CSS (Compilado con Vite) -->
            ...
            <div class="hero-visual-col">
                <div class="top-cards-row">
                    ...
                    <div class="info-card">
                        ...
                        <!-- RUTA DE TU ÍCONO 1 -->
                        <img src="{{ asset('images/icono-personal.png') }}" alt="Personal" class="card-icon">
                    </div>
                    ...
                    <div class="info-card">
                        ...
                        <!-- RUTA DE TU ÍCONO 2 -->
                        <img src="{{ asset('images/icono-inventario.png') }}" alt="Inventario" class="card-icon">
                    </div>
                </div>
                ...
                <div class="main-image-card">
                    ...
                    <img src="{{ asset('images/modelo-principal.png') }}" alt="Gestión" class="man-image">
                </div>
            </div>
        </main>
    </div>
