...
<body class="bg-linear-to-br from-slate-50 via-sky-50/30 to-teal-50/20 flex justify-center items-center min-h-screen p-3 md:p-6 overflow-hidden">
  ...
  <div class="flex flex-col lg:flex-row items-center w-full max-w-(1380px) h-[92vh] max-h-(860px) bg-white/95 backdrop-blur-xl rounded-[28px] shadow-[0_20px_50px_rgba(12,67,83,0.08)] border border-white overflow-hidden animate-fade-in">
    ...
    <div class="hidden lg:flex flex-col justify-between p-10 xl:p-12 w-[42%] h-full relative overflow-hidden bg-[#0C4353]">
      ...
      <img src="<?php echo e(asset('images/merceria.png')); ?>" alt="Fachada de tienda" class="absolute inset-0 w-full h-full object-cover object-center scale-105 opacity-90 transition-transform duration-700 hover:scale-100" />
      ...
      <div class="w-full max-w-(580px) mx-auto flex flex-col gap-3 h-full">
        ...
        <div class="flex flex-col gap-2 w-full shrink-0">
          <div class="flex justify-between items-center">
            <a href="<?php echo e(route('register.step', ['step' => 1])); ?>" class="flex items-center justify-center w-9 h-9 bg-slate-100 hover:bg-slate-200 text-slate-600 rounded-full transition-all shadow-sm">
        ...
        <form id="businessForm" action="<?php echo e(route('register.step.store', ['step' => 2])); ?>" method="GET" class="flex flex-col gap-3 w-full overflow-y-auto custom-scroll pr-1 py-1">
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-3">
            <div class="flex flex-col gap-1">
              ...
              <input type="text" id="nombre_tienda" name="nombre_tienda" value="<?php echo e(old('nombre_tienda', $formData['nombre_tienda'] ?? '')); ?>" placeholder="Ej: Tienda Nadal Sur" class="px-3.5 py-2 w-full bg-slate-50 border border-slate-200 rounded-xl text-xs text-slate-800 placeholder:text-slate-400 focus:bg-white focus:outline-none focus:ring-2 focus:ring-[#146F8A]/20 focus:border-[#146F8A] transition-all shadow-sm" required />
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-3">
            <div class="flex flex-col gap-1">
              ...
              <input type="text" id="ciudad" name="ciudad" value="<?php echo e(old('ciudad', $formData['ciudad'] ?? '')); ?>" placeholder="Ej: Managua" class="px-3.5 py-2 w-full bg-slate-50 border border-slate-200 rounded-xl text-xs text-slate-800 placeholder:text-slate-400 focus:bg-white focus:outline-none focus:ring-2 focus:ring-[#146F8A]/20 focus:border-[#146F8A] transition-all shadow-sm" required />
            ...
            <div class="flex flex-col gap-1">
              ...
              <input type="text" id="codigo_postal" name="codigo_postal" value="<?php echo e(old('codigo_postal', $formData['codigo_postal'] ?? '')); ?>" placeholder="Ej: 11001" class="px-3.5 py-2 w-full bg-slate-50 border border-slate-200 rounded-xl text-xs text-slate-800 placeholder:text-slate-400 focus:bg-white focus:outline-none focus:ring-2 focus:ring-[#146F8A]/20 focus:border-[#146F8A] transition-all shadow-sm" required />
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-3">
            <div class="flex flex-col gap-1">
              ...
              <input type="email" id="correo_tienda" name="correo_tienda" value="<?php echo e(old('correo_tienda', $formData['correo_tienda'] ?? '')); ?>" placeholder="tienda@gintly.com" class="px-3.5 py-2 w-full bg-slate-50 border border-slate-200 rounded-xl text-xs text-slate-800 placeholder:text-slate-400 focus:bg-white focus:outline-none focus:ring-2 focus:ring-[#146F8A]/20 focus:border-[#146F8A] transition-all shadow-sm" />
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-3">
            <div class="flex flex-col gap-1">
              ...
              <input type="number" min="1" id="numero_sucursales" name="numero_sucursales" value="<?php echo e(old('numero_sucursales', $formData['numero_sucursales'] ?? '1')); ?>" class="px-3.5 py-2 w-full bg-slate-50 border border-slate-200 rounded-xl text-xs text-slate-800 focus:bg-white focus:outline-none focus:ring-2 focus:ring-[#146F8A]/20 focus:border-[#146F8A] transition-all shadow-sm" required />
            ...
            <div class="flex flex-col gap-1">
              ...
              <input type="text" id="ruc" name="ruc" value="<?php echo e(old('ruc', $formData['ruc'] ?? '')); ?>" placeholder="J0310000000001" class="px-3.5 py-2 w-full bg-slate-50 border border-slate-200 rounded-xl text-xs text-slate-800 placeholder:text-slate-400 focus:bg-white focus:outline-none focus:ring-2 focus:ring-[#146F8A]/20 focus:border-[#146F8A] transition-all shadow-sm" required />
...
</html><?php /**PATH C:\laragon\www\gintly_app\resources\views/auth/register-step2.blade.php ENDPATH**/ ?>