...
<body class="bg-linear-to-br from-slate-50 via-sky-50/30 to-teal-50/20 flex justify-center items-center min-h-screen p-3 md:p-5 overflow-hidden">
  ...
  <div class="flex flex-col w-full max-w-(1240px) h-[94vh] max-h-(820px) bg-white/95 backdrop-blur-xl rounded-[28px] shadow-[0_20px_50px_rgba(12,67,83,0.08)] border border-white p-5 md:p-8 animate-fade-in justify-between">
    ...
    <div class="flex flex-col gap-2.5">
      <div class="flex justify-between items-center">
        <a href="<?php echo e(route('register.step', ['step' => 5])); ?>" class="flex items-center justify-center w-8 h-8 bg-slate-100 hover:bg-slate-200 text-slate-600 rounded-full shadow-sm hover:scale-105 active:scale-95 cursor-pointer">
          <span class="font-bold text-sm">←</span>
        </a>
        <div class="flex items-center justify-center h-7 px-2 bg-slate-50/50 rounded-xl">
          <img src="<?php echo e(asset('images/gintlylogo.png')); ?>" alt="Gintly Logo" class="h-6 w-auto object-contain" />
        </div>
      </div>
  ...
  <script>
    ...
    function submitCheckoutForm() {
        ...
        window.location.href = "<?php echo e(route('register.step', ['step' => 7])); ?>";
    }
...
</html><?php /**PATH C:\laragon\www\gintly_app\resources\views/auth/register-step6.blade.php ENDPATH**/ ?>